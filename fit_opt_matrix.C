...
void fit_opt_matrix(TString fname="Optics_all_-10_fit_tree") {
  gROOT->Reset();
  gStyle->SetOptStat(0);
 ...
 //
   string newcoeffsfilename="hms_newfit_all_-10.dat";
     string oldcoeffsfilename="hms_recon_coeff_opt2018.dat";
  int nfit=0,npar,nfit_max=60000,npar_final=0,max_order=6,norder;
...
//Declaration of leaves types
 ...
 const Int_t nfoils=5;
  vector <Double_t> ztar_foil;
	...
	static const Int_t ndelcut=6;
	Double_t delcut[ndelcut+1]={-10,-8,-6,-3,0.,5.,10.};
